...
var parser = function () {
    var parser = { trace: function trace() {},
        yy: {},
        symbols_: { "error": 2, "expressions": 3, "e": 4, "EOF": 5, "NUMBER": 6, "INVALID": 7, "(": 8, ")": 9, ",": 10, "Int": 11, "Number": 12, "Bool": 13, "String": 14, "Enum": 15, "Date": 16, "Array": 17, "$accept": 0, "$end": 1 },
        terminals_: { 2: "error", 5: "EOF", 6: "NUMBER", 7: "INVALID", 8: "(", 9: ")", 10: ",", 11: "Int", 12: "Number", 13: "Bool", 14: "String", 15: "Enum", 16: "Date", 17: "Array" },
        productions_: [0, [3, 2], [4, 1], [4, 1], [4, 3], [4, 3], [4, 2], [4, 2], [4, 2], [4, 2], [4, 2], [4, 2], [4, 2], [4, 2]],
        ...
        /**/) {
            ...
            switch (yystate) {
                ...
                case 5:
                    ...
                    break;
                case 6:
                    this.$ = _typegines2.default.int.apply(_typegines2.default, [].concat($$[$0]));
                    break;
                case 7:
                    this.$ = _typegines2.default.number.apply(_typegines2.default, [].concat($$[$0]));
                    break;
                case 8:
                    this.$ = _typegines2.default.bool.apply(_typegines2.default, [].concat($$[$0]));
                    break;
                case 9:
                    this.$ = _typegines2.default.string.apply(_typegines2.default, [].concat($$[$0]));
                    break;
                case 10:
                    this.$ = _typegines2.default.enum.apply(_typegines2.default, [].concat($$[$0]));
                    break;
                case 11:
                    this.$ = _typegines2.default.date.apply(_typegines2.default, [].concat($$[$0]));
                    break;
                case 12:
                    this.$ = _typegines2.default.array.apply(_typegines2.default, [].concat($$[$0]));
                    break;
                case 13:
                    this.$ = null;
                    break;
        ...
        table: [{ 3: 1, 4: 2, 6: [1, 3], 7: [1, 4], 8: [1, 5], 11: [1, 6], 12: [1, 7], 13: [1, 8], 14: [1, 9], 15: [1, 10], 16: [1, 11], 17: [1, 12] }, { 1: [3] }, { 5: [1, 13], 10: [1, 14] }, { 5: [2, 2], 9: [2, 2], 10: [2, 2] }, { 5: [2, 3], 9: [2, 3], 10: [2, 3] }, { 4: 15, 6: [1, 3], 7: [1, 4], 8: [1, 5], 9: [1, 16], 11: [1, 6], 12: [1, 7], 13: [1, 8], 14: [1, 9], 15: [1, 10], 16: [1, 11], 17: [1, 12] }, { 4: 17, 6: [1, 3], 7: [1, 4], 8: [1, 5], 11: [1, 6], 12: [1, 7], 13: [1, 8], 14: [1, 9], 15: [1, 10], 16: [1, 11], 17: [1, 12] }, { 4: 18, 6: [1, 3], 7: [1, 4], 8: [1, 5], 11: [1, 6], 12: [1, 7], 13: [1, 8], 14: [1, 9], 15: [1, 10], 16: [1, 11], 17: [1, 12] }, { 4: 19, 6: [1, 3], 7: [1, 4], 8: [1, 5], 11: [1, 6], 12: [1, 7], 13: [1, 8], 14: [1, 9], 15: [1, 10], 16: [1, 11], 17: [1, 12] }, { 4: 20, 6: [1, 3], 7: [1, 4], 8: [1, 5], 11: [1, 6], 12: [1, 7], 13: [1, 8], 14: [1, 9], 15: [1, 10], 16: [1, 11], 17: [1, 12] }, { 4: 21, 6: [1, 3], 7: [1, 4], 8: [1, 5], 11: [1, 6], 12: [1, 7], 13: [1, 8], 14: [1, 9], 15: [1, 10], 16: [1, 11], 17: [1, 12] }, { 4: 22, 6: [1, 3], 7: [1, 4], 8: [1, 5], 11: [1, 6], 12: [1, 7], 13: [1, 8], 14: [1, 9], 15: [1, 10], 16: [1, 11], 17: [1, 12] }, { 4: 23, 6: [1, 3], 7: [1, 4], 8: [1, 5], 11: [1, 6], 12: [1, 7], 13: [1, 8], 14: [1, 9], 15: [1, 10], 16: [1, 11], 17: [1, 12] }, { 1: [2, 1] }, { 4: 24, 6: [1, 3], 7: [1, 4], 8: [1, 5], 11: [1, 6], 12: [1, 7], 13: [1, 8], 14: [1, 9], 15: [1, 10], 16: [1, 11], 17: [1, 12] }, { 9: [1, 25], 10: [1, 14] }, { 5: [2, 13], 9: [2, 13], 10: [2, 13] }, { 5: [2, 6], 9: [2, 6], 10: [2, 6] }, { 5: [2, 7], 9: [2, 7], 10: [2, 7] }, { 5: [2, 8], 9: [2, 8], 10: [2, 8] }, { 5: [2, 9], 9: [2, 9], 10: [2, 9] }, { 5: [2, 10], 9: [2, 10], 10: [2, 10] }, { 5: [2, 11], 9: [2, 11], 10: [2, 11] }, { 5: [2, 12], 9: [2, 12], 10: [2, 12] }, { 5: [2, 5], 9: [2, 5], 10: [2, 5] }, { 5: [2, 4], 9: [2, 4], 10: [2, 4] }],
    ...
    var lexer = function () {
        var lexer = {
            ...
            rules: [/^(?:\s+|'|")/, /^(?:\d+(\.\d+)?$\b)/, /^(?:\()/, /^(?:\))/, /^(?:int\b)/, /^(?:number\b)/, /^(?:array\b)/, /^(?:bool\b)/, /^(?:string\b)/, /^(?:date\b)/, /^(?:enum\b)/, /^(?:,)/, /^(?:$)/, /^(?:[^(),]*)/],
